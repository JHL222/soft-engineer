...
document.addEventListener("DOMContentLoaded", function () {
  ...
  const texts = [
    ...
    "사고현황, 교통 안전 법률, 안전 교육 영상과 같은 컨텐츠를 제공하여 사고 예방 및 법적 준수, 실질적인 지식을 통해 긴급상황에서도 침착하고 효과적인 대응을 가능하게 하고, 개인뿐만 아니라 지역사회 전체에서 안전에 대한 인식을 높여 안전 문화를 조성합니다.", "공모전에 참여할 기회를 제공하여, 참여자들이 안전 운전에 대한 창의적인 아이디어를 제출하도록 유도함으로써, 창의성을 발휘할 수 있는 기회를 제공합니다.",
    "RRC 퀴즈 페이지는 Road Respect Campaign (RRC)의 중요한 구성 요소로, 도로 안전에 대한 이해를 재미있고 흥미로운 방식으로 높이는 것을 목표로 합니다. 이 페이지는 도로 이용자들이 도로 교통 관련 지식을 테스트하고, 영상을 통해서 배운 내용을 점검하며, 안전 문화를 더욱 강화할 수 있는 기회를 제공합니다.",
    "후원 페이지는 Road Respect Campaign (RRC)의 중요한 부분으로, 우리의 비전을 실현하는 데 필요한 자원을 확보하는 데 중추적인 역할을 합니다. 후원자들의 지원 덕분에 우리는 더 많은 사람들에게 도로 안전의 중요성을 알리고, 다양한 교육 프로그램과 캠페인을 전개할 수 있습니다."
  ];
